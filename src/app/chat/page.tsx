...
// //   Continue --> Finish
// //   Decision -->|No| FixIssue
// //   FixIssue --> Start

// //   style Decision fill:#E0E0FF,stroke:#666,stroke-width:2px;
// //   style Start fill:#DDF,stroke:#333;
// //   style FixIssue fill:#FCC;
...
//     subgraph Assessment["評估階段"]
//         subgraph Status["狀況評估"]
//             A1["債務狀況盤點"]
//             A2["債務風險評估"]
//         end

//         subgraph Resources["資源評估"]
//             R1["內部資源盤點"]
//             R2["外部資源盤點"]
//             R3["可用資源評估"]
//         end
